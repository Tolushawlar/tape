...
const Page = () => {
    ...
    return (
        <div className={`${globalState ? 'fixed' : ''}  flex flex-col items-center justify-center w-full`}>
            ...
            <p className='text-[24px] font-Clash-Display font-500 mt-10'>OTHER RELATED POST</p>
