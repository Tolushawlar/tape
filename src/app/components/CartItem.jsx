...
//             <Image src="https://res.cloudinary.com/dtlxunbzr/image/upload/v1725545543/cardImage_dgxddb.png" width={87.7} height={86.93} alt="logo" />
...
const CartItem = ({ item, removeFromCart }) => {
    return (
        <div className='flex flex-row items-center justify-start gap-10 mt-10 w-full'>
            {/* Render item image */}
            <Image src={item.defaultImage} width={87.7} height={86.93} alt={item.name} />
