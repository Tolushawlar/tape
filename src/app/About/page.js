    ...
    return (
        <div className={`${globalState ? 'fixed' : ''}  overflow-x-hidden`}>
            ...
            <div className='bg-cover bg-center w-screen h-[484px] flex flex-row items-start justify-start text-center' style={{ backgroundImage: `url("https://res.cloudinary.com/dtlxunbzr/image/upload/v1725546068/image_1_fxlnsy.png")` }}>
                <div className='flex flex-col items-start justify-start gap-[200px] bg-black  w-1/3 h-[484px] '>
                ...
                <div className='flex flex-col items-start justify-start gap-[200px] bg-transparent  w-1/3 h-[484px] '>
                    {/* <div className=' flex flex-col items-start justify-start gap-5 px-10 py-10 '>
                        <p className="text-[16px] font-[600px] font-CLash-Regular text-white text-left">BUY LESS, BUT BETTER</p>
                        <p className='text-[14px] font-normal font-Sweet-Regular text-white text-left'>Lorem ipsum dolor sit amet consectetur. Odio velit placerat sit nulla pretium lectus phasellus. Magna tellus porta sem viverra at ornare enim ante sit. Diam tellus tellus odio donec varius hendrerit facilisis vitae massa. </p>
                    </div> */}
            ...
            <div className='bg-cover bg-center w-screen h-[484px] flex flex-row items-end justify-end text-center' style={{ backgroundImage: `url("https://res.cloudinary.com/dtlxunbzr/image/upload/v1725546070/image_14_ztvgvg.png")` }}>
                ...
                <div className='flex flex-col items-start justify-start gap-[200px] bg-[#082A63]  w-1/3 h-[484px] '>
                    <div className=' flex flex-col items-start justify-start gap-5 px-10 py-10 '>
                        <p className="text-[16px] font-[600px] font-CLash-Regular text-white text-left">WEAR EACH ITEM, LONGER</p>
                        <p className='text-[14px] font-normal font-Sweet-Regular text-white text-left'>Lorem ipsum dolor sit amet consectetur. Odio velit placerat sit nulla pretium lectus phasellus. Magna tellus porta sem viverra at ornare enim ante sit. Diam tellus tellus odio donec varius hendrerit facilisis vitae massa. </p>
                    </div>
