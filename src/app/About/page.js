...
function About() {
    ...
    return (
        <div>
            ...
            <div className='bg-cover bg-center h-[645px] flex flex-row items-center justify-center  z-50' style={{ backgroundImage: `url("https://res.cloudinary.com/dtlxunbzr/image/upload/v1725546072/image_13_y3nvqt.png")` }}>
