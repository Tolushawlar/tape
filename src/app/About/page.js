...
const About = () => {
    ...
    return (
        <div className={`${globalState ? 'fixed' : ''}  overflow-x-hidden overflow-y-hidden`}>
            <div className='bg-cover bg-center w-screen md:h-[484px] h-[400px] flex flex-row items-center justify-center text-center' style={{ backgroundImage: `url("https://res.cloudinary.com/dtlxunbzr/image/upload/v1725546069/top_hq8zhb.png")` }}>
            ...
            <div className='bg-cover bg-center w-screen h-[484px] flex flex-row items-start justify-start text-center' style={{ backgroundImage: `url("https://res.cloudinary.com/dtlxunbzr/image/upload/v1725546068/image_1_fxlnsy.png")` }}>
            ...
            <div className='bg-cover bg-center w-screen h-[645px] flex flex-row items-center justify-center  z-50' style={{ backgroundImage: `url("https://res.cloudinary.com/dtlxunbzr/image/upload/v1725546072/image_13_y3nvqt.png")` }}>
            ...
            <div className='bg-cover bg-center w-screen h-[484px] flex flex-row items-end justify-end text-center' style={{ backgroundImage: `url("https://res.cloudinary.com/dtlxunbzr/image/upload/v1725546070/image_14_ztvgvg.png")` }}>
                <div className='flex flex-col items-start justify-start gap-[200px] bg-transparent  md:w-1/3 h-[484px] '>
                    {/* <div className=' flex flex-col items-start justify-start gap-5 px-10 py-10 '>
